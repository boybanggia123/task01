...
export default function Home() {
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src="img/02.01.22_CollectionBanner_2048x550_BlackExcellence2.webp" className="d-block w-100" alt="..."/>
    </div>
    <div className="carousel-item">
      <img src="img/7.19.21_CollectionBanner_70s.webp" className="d-block w-100" alt="..."/>
    </div>
    <div className="carousel-item">
      <img src="img/10.25.22_CollectionBanner_FallLayers_copy_1.webp" className="d-block w-100" alt="..."/>
    </div>
  </div>
  ...
  <button className="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
    ...
    <div className="row mt-4">
      <div className="col show-main">
        <div className="text-center  ">
      <img src="img/fashionnovablog.jpg" className="rounded" alt="..."/>
  ...
  <div className="col-12 col-md-6 mb-4">
    <div className="card ">
      ...
      <img src="img/fashionnovablog.jpg" className="card-img-top" alt="..." />
      <button className="fw-bold" >CATEGORY</button>
      </div>
      
      <div className="card-body text-start">
        <h5 className="card-title fw-bold">Product Title Goes Here</h5>
        <p className="card-text fs-6">BRAND</p>
        <div className="d-flex justify-content-between titel">
          <p className="fw-light text-decoration-line-through">AED 32.00</p>
  ...
  <div className="col-sm-12 col-md-6 col-lg-3 mb-4">
    ...
    <div className="img-sup">
      ...
      <img src="img/bannerfooter.webp" className="img-fluid mt-5 " style={{width:'100%'}} alt="..."/>
  ...
  <div className="col-sm-12 col-md-6 col-lg-3 mb-4">
    ...
    <img src="img/bannerfooter.webp" className="img-fluid mt-5 mb-5" style={{width:'100%'}} alt="..."/>
  ...
  <div className="row  justify-content-between">
    ...
    <div className="col-lg-3">
      ...
      <p><a className="btn btn-body rounded-5 border-dark" href="#">@username</a></p>
